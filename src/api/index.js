...
export async function customFetch(path, headerOptions) {
...
function requestWrapper(method) {
  return async function fetchAPI(url, data = null, params = {}) {
    let convertUrl =
      process.env.REACT_APP_SERVER_URL + process.env.REACT_APP_API_PATH + url;
